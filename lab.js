...
/*
  ...
  based on the above temperature and rain.If it is 80 degrees or above, and raining, one should wear a t-shirt and take an umbrella. f it is 
...
while(score < passingScore){
  console.log("Your score is not high enough. Current score: " + score);
  score++;
}
...
console.log("changeMyMind is now: " + changeMyMind)
////////// PROBLEM 10 //////////
...
if(changeMyMind !== true){
  changeMyMind = true
  console.log("changeMyMind current value is: " + changeMyMind)
}
